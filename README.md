...
XNNPACK provides ~3x throughput over estimated naive CPU path at zero cost.
...
Defaults to child classification, triggering false alerts on parent.
...
Uses bounding box of 11 upper-body keypoints (nose, shoulders, elbows, wrists, hips, knees).
